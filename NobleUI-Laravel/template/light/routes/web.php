...
Route::group(['prefix' => 'studio'], function(){
    Route::get('studio-profiles', function () { return view('pages.studio.studio-profiles'); });
...
Route::group(['prefix' => 'packages'], function(){
    Route::get('create-packages', function () { return view('pages.packages.create-packages'); });
    Route::get('view-packages', function () { return view('pages.packages.view-packages'); });
...
Route::group(['prefix' => 'users'], function(){
    Route::get('user-tables', function () { return view('pages.users.user-tables'); });
