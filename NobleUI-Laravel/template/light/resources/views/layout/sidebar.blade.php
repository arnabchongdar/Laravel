<nav class="sidebar">
  ...
  <div class="sidebar-body">
    <ul class="nav">
      ...
      <li class="nav-item {{ active_class(['studio/*']) }}">
        <a class="nav-link" data-toggle="collapse" href="#studio" role="button" aria-expanded="{{ is_active_route(['studio/*']) }}" aria-controls="advanced-ui">
          <i class="link-icon" data-feather="anchor"></i>
          <span class="link-title">Studio</span>
          <i class="link-arrow" data-feather="chevron-down"></i>
        </a>
        <div class="collapse {{ show_class(['studio/*']) }}" id="studio">
          <ul class="nav sub-menu">
            <li class="nav-item">
              <a href="{{ url('/studio/studio-profiles') }}" class="nav-link {{ active_class(['studio/studio-profiles']) }}">Studio Profiles</a>
            </li>
      ...
      <li class="nav-item {{ active_class(['packages/*']) }}">
        <a class="nav-link" data-toggle="collapse" href="#packages" role="button" aria-expanded="{{ is_active_route(['packages/*']) }}" aria-controls="forms">
          <i class="link-icon" data-feather="inbox"></i>
          <span class="link-title">Packages</span>
          <i class="link-arrow" data-feather="chevron-down"></i>
        </a>
        <div class="collapse {{ show_class(['packages/*']) }}" id="packages">
          <ul class="nav sub-menu">
            <li class="nav-item">
              <a href="{{ url('/packages/create-packages') }}" class="nav-link {{ active_class(['packages/create-packages']) }}">Create Packages</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('/packages/view-packages') }}" class="nav-link {{ active_class(['packages/view-packages']) }}">View Packages</a>
            </li>
      ...
      <li class="nav-item {{ active_class(['users/*']) }}">
        ...
        <div class="collapse {{ show_class(['users/*']) }}" id="users">
          <ul class="nav sub-menu">
            <li class="nav-item">
              <a href="{{ url('/users/user-tables') }}" class="nav-link {{ active_class(['users/user-tables']) }}">User Tables</a>
            </li>
