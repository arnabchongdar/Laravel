  ...
  <div class="col-xl-10 main-content pr-xl-4 pl-xl-5">
    ...
    <div class="example">
      <div class="media d-block d-sm-flex">
        <img src="{{ url('assets/images/placeholder.jpg') }}" class="wd-100p wd-sm-200 mb-3 mb-sm-0 ml-3" alt="...">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="media d-block d-sm-flex">
  <img src="..." class="wd-100p wd-sm-200 mb-3 mb-sm-0 ml-3" alt="...">
  <div class="media-body">
    <h5 class="mt-0">Media heading</h5>
    <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
  </div>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="media d-block d-sm-flex">
  ...
  <div class="media-body">
    ...
    <div class="example">
      <div class="media d-block d-sm-flex">
        <img src="{{ url('assets/images/placeholder.jpg') }}" class="wd-100p mb-3 mb-sm-0 align-self-start ml-3 wd-sm-150" alt="...">
        <div class="media-body">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="media d-block d-sm-flex">
  <img src="..." class="wd-100p mb-3 mb-sm-0 align-self-start ml-3 wd-sm-150" alt="...">
  <div class="media-body">
    <h5 class="mt-0">Top-aligned media</h5>
    <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
    <p>Donec sed odio dui. Nullam quis risus eget urna mollis ornare vel eu leo. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
    ...
    <div class="example">
      <div class="media d-block d-sm-flex">
        <img src="{{ url('assets/images/placeholder.jpg') }}" class="align-self-center wd-100p wd-sm-150 mb-3 mb-sm-0 ml-3" alt="...">
        <div class="media-body">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="media d-block d-sm-flex">
  <img src="..." class="align-self-center wd-100p wd-sm-150 mb-3 mb-sm-0 ml-3" alt="...">
  <div class="media-body">
    ...
  </div>
</div></script></code></pre>
    ...
    <div class="example">
      <div class="media d-block d-sm-flex">
        <img src="{{ url('assets/images/placeholder.jpg') }}" class="align-self-end wd-100p wd-sm-150 mb-3 mb-sm-0 ml-3" alt="...">
        <div class="media-body">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="media d-block d-sm-flex">
  <img src="..." class="align-self-end wd-100p wd-sm-150 mb-3 mb-sm-0 ml-3" alt="...">
  <div class="media-body">
    ...
  </div>
</div></script></code></pre>
